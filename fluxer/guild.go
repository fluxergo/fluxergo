...
const (
	...
	GuildFeatureVIPVoiceRegions                GuildFeature = "VIP_VOICE"
	...
	GuildFeatureMtMessageScheduling            GuildFeature = "MT_MESSAGE_SCHEDULING"
	GuildFeatureMtExpressionPacks              GuildFeature = "MT_EXPRESSION_PACKS"
)
...
type Guild struct {
	...
	DisabledOperations          int                        `json:"disabled_operations"`
	MessageHistoryCutoff        *string                    `json:"message_history_cutoff"`
