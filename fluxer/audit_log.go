...
const (
	...
	// AuditLogChangeKeyRoleAdd is sent when roles are added to a user (array of fluxer.PartialRole JSON)
	AuditLogChangeKeyRoleAdd AuditLogChangeKey = "$add"
	// AuditLogChangeKeyRoleRemove is sent when roles are removed from a user (array of fluxer.PartialRole JSON)
