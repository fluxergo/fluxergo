...
var (
	...
	GetBotApplicationInfo    = NewEndpoint(http.MethodGet, "/oauth2/applications/{application.id}/bot")
	ApplicationBotResetToken = NewEndpoint(http.MethodPost, "/oauth2/applications/{application.id}/bot/reset-token")
...
func (e *Endpoint) Compile(values fluxer.QueryValues, params ...any) *CompiledEndpoint {
