...
type GenericGuildScheduledEvent struct {
	*GenericEvent
	GuildScheduled fluxer.GuildScheduledEvent
}
...
type GuildScheduledEventUpdate struct {
	*GenericGuildScheduledEvent
	OldGuildScheduled fluxer.GuildScheduledEvent
}
...
// GuildScheduledEvent returns the fluxer.GuildScheduledEvent the event is for.
func (e *GenericGuildScheduledEventUser) GuildScheduledEvent() (fluxer.GuildScheduledEvent, bool) {
...
func (e *GenericGuildScheduledEventUser) Member() (fluxer.Member, bool) {
	return e.Client().Caches.Member(e.GuildID, e.UserID)
}

// GuildScheduledEventUserAdd is dispatched when a user is added to a fluxer.GuildScheduledEvent.
type GuildScheduledEventUserAdd struct {
	*GenericGuildScheduledEventUser
}

// GuildScheduledEventUserRemove is dispatched when a user is removed from a fluxer.GuildScheduledEvent.
